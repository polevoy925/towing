...
namespace CarCareTracker.Helper
{
    ...
    public class MailHelper : IMailHelper
    {
        ...
        public OperationResponse NotifyUserForRegistration(string emailAddress, string token)
        {
            ...
            string emailSubject = _translator.Translate(serverLanguage, "Your Registration Token for the Omelyana Fleet App");
            string emailBody = $"{_translator.Translate(serverLanguage, "A token has been generated on your behalf, please complete your registration for the Omelyana Towing using the token")}: {token}";
        ...
        public OperationResponse NotifyUserForPasswordReset(string emailAddress, string token)
        {
            ...
            string emailSubject = _translator.Translate(serverLanguage, "Your Password Reset Token for Omelyana Fleet App");
            string emailBody = $"{_translator.Translate(serverLanguage, "A token has been generated on your behalf, please reset your password for Omelyana Towing using the token")}: {token}";
            var result = SendEmail(new List<string> { emailAddress }, emailSubject, emailBody);
            if (result)
            {
                return OperationResponse.Succeed("Email Sent!");
        ...
        public OperationResponse SendTestEmail(string emailAddress)
        {
            ...
            string emailSubject = _translator.Translate(serverLanguage, "Test Email from Omelyana Towing");
        ...
        public OperationResponse NotifyUserForAccountUpdate(string emailAddress, string token)
        {
            ...
            string emailSubject = _translator.Translate(serverLanguage, "Your User Account Update Token for Omelyana Towing");
            string emailBody = $"{_translator.Translate(serverLanguage, "A token has been generated on your behalf, please update your account for Omelyana Towing using the token")}: {token}";
            var result = SendEmail(new List<string> { emailAddress}, emailSubject, emailBody);
            if (result)
            {
                return OperationResponse.Succeed("Email Sent!");
        ...
        public OperationResponse NotifyUserForReminders(Vehicle vehicle, List<string> emailAddresses, List<ReminderRecordViewModel> reminders)
        {
            ...
            string emailSubject = $"{_translator.Translate(serverLanguage, "Vehicle Reminders From Omelyana Towing")} - {DateTime.Now.ToShortDateString()}";
